...
import Project2 from '../../public/images/projects/infochalten.webp'
import Project4 from '../../public/images/projects/yarara.webp'
import Project3 from '../../public/images/projects/serviceoficial-caba.webp'
import { motion } from 'framer-motion'
import TransitionEffect from '@/components/TransitionEffect'
import Cubes from '../../public/images/profile/bgtech.jpg'
     ...
     '>
      ...
      <div className='w-1/2 flex flex-col items-start justify-between pl-6 lg:w-full lg:pl-0 lg:pt-6'>
        ...
        <div className='mt-2 flex items-center'>
          ...
          <Link href="https://haushguitars.com" target={"_blank"} className='ml-4 rounded-lg bg-dark text-light p-2 px-6 text-lg font-semibold sm:px-4 sm:text-base'>Visitá la página</Link>
        </div>
      </div>
